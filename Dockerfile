...
ENV PATH="$JAVA_HOME/bin:$PATH:$ANDROID_HOME/cmdline-tools/latest/cmdline-tools/bin:$ANDROID_HOME/platform-tools:$ANDROID_HOME/emulator"

# Instala o Android command-line tools com estrutura correta
...
RUN ${ANDROID_HOME}/cmdline-tools/latest/cmdline-tools/bin/sdkmanager --version

# Instala SDKs necessários
RUN yes | ${ANDROID_HOME}/cmdline-tools/latest/cmdline-tools/bin/sdkmanager --licenses && \
...
RUN echo "no" | ${ANDROID_HOME}/cmdline-tools/latest/cmdline-tools/bin/avdmanager \
